      ...
      <main className="about-page text-gray-200 bg-[var(--background-color)] min-h-screen py-16 px-6 md:px-20">
        <section className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-lg leading-relaxed text-[var(--text-muted)]">
            ...
            connect with people on a deeply personal level — to make readers
            laugh, reflect, cry, and most importantly, *remember*.
          </p>
          ...
          <p className="text-lg leading-relaxed text-[var(--text-color)]">
            When we started, we had no idea what this would become. There were
            no big sponsors or investors — just consistency, creativity, and a
            burning desire to make something people could relate to. We wrote
            stories through late nights, built a loyal fan base from scratch,
            and slowly turned a simple WhatsApp platform into a brand that now
            collaborates with advertisers, creators, and storytellers from
            across the country.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-4 text-[var(--text-color)]">
            ...
            <li>
              ...
              platforms, maintaining the same storytelling quality that built
              our reputation.
            </li>
            <li>
          ...
          <p className="text-lg leading-relaxed text-[var(--text-muted)]">
            ...
            connecting with real people who genuinely engage with what we
            create.
          </p>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-color)] p-6 rounded-xl shadow-md mt-10">
            ...
            <p className="mt-4 text-[var(--text-muted)] italic">
              “Stories that touch. Emotions that last. A platform that
              connects.”
            </p>
          </div>
